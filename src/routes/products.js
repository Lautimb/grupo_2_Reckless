...
router.post(
  "/create",
  admin,
  multerProducts.array("images"),
  validator.products,
  productsController.store
); // Accion de creacion (a donde se envia el formulario)
...
router.put("/edit/:id", validator.products, productsController.update); // Accion de edicion (a donde se envia la informacion solicitada en el formulario)
