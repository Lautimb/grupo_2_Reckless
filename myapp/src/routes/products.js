...
router.put('/edit/:id', multerProducts.array('images', 6), productsController.editStore); // Accion de edicion (a donde se envia la informacion solicitada en el formulario)
