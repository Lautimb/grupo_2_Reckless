...
module.exports = {
  register: [
    ...
    body("lastName").notEmpty().withMessage("Please fill the last name"),
    body("email")
      .notEmpty()
    ...
    body("retype").notEmpty().withMessage("Please retype your password").bail(),
    body("birthday")
      .custom((value, { req }) => {
  ...
  login: [
    body("email")
      ...
      .bail(),
    body("password").notEmpty().withMessage("Please fill the password").bail(),
  ],
  ...
  products: [
    ...
    body("art").notEmpty().withMessage("Please fill product's article code"),
    body("size").notEmpty().withMessage("Please select a size"),
    body("type").notEmpty().withMessage("Please select product's type"),
  ],
};
